...
import PensionerCardSheet from "@/components/PensionerCardSheet";
import OrganDonorCardSheet from "@/components/OrganDonorCardSheet";
...
export default function Wallet() {
  ...
  return (
    <div className="min-h-screen bg-[#f0f0f0] flex flex-col w-screen">
      {/* Header */}
      ...
      <OrganDonorCardSheet open={organOpen} onClose={() => setOrganOpen(false)} profile={profile} />
    </div>
  );
}